...
\mobile{(+86) 18767105037}

\email{tianjiangziwu@gmail.com}
\homepage{blog.csdn.net/a352614834}
\github{ntrntr}
%\linkedin{posquit0}
%\skype{skypeid}
...
\position{申请职位:高级游戏研发工程师} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{杨志翔~~~·~~~简历}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
